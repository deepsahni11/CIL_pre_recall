...
# y_test_datasets_5d_resampled = load('../datasets_6d_y_test_resampled.npy')
...
np.savetxt('datasets_nn_6d_precision.csv', matrixp.tolist() ,delimiter=',',fmt='%f') 
np.savetxt('datasets_nn_6d_recall.csv', matrixr.tolist() ,delimiter=',',fmt='%f') 
np.savetxt('datasets_nn_6d_f1.csv', matrixf1.tolist() ,delimiter=',',fmt='%f') 
