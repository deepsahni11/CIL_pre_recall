...
prediction_y = torch.load("datasets_8d_y_prediction.pt", map_location='cpu')#, allow_pickle = True)

# prediction_y = torch.load('datasets_8d_y_prediction_y.pt')
y_test_datasets_5d_resampled = np.load("datasets_8d_y_test_resampled.npy", allow_pickle = True)

# y_test_datasets_5d_resampled = load('../datasets_8d_y_test_resampled.npy')
...
np.savetxt('datasets_nn_8d_precision.csv', matrixp.tolist() ,delimiter=',',fmt='%f') 
np.savetxt('datasets_nn_8d_recall.csv', matrixr.tolist() ,delimiter=',',fmt='%f') 
np.savetxt('datasets_nn_8d_f1.csv', matrixf1.tolist() ,delimiter=',',fmt='%f') 
